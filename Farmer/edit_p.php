...
if(isset($_GET['edit_p'])){
    ...
    $p_title=$row_edit['product_tltle'];
...
<body>
    ...
    <div class="row">
        <div class="col-lg-12">
            <ol class="breadcrumb">
                <li class="active">
                    <i class="fa fa-dasboard"></i>Edit Products
                </li>
                <ol>
        </div>
    </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <br><img src="product_image/<?php echo $p_image1; ?>" width="70" height="70">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <br><img src="product_image/<?php echo $p_image2; ?>" width="70" height="70">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <br><img src="product_image/<?php echo $p_image3; ?>" width="70" height="70">
                                </div>
                            </div>
...
$update_product="UPDATE products set p_cat_id='$product_cat',cat_id='$cat',date=NOW(),product_tltle='$product_title',
product_img1='$product_img1',product_img2='$product_img2',product_img3='$product_img3',product_price='$product_price',
product_desc='$product_desc',product_keyword='$product_keyword' where product_id='$p_id' AND farmer_id='$farmer_id'";
