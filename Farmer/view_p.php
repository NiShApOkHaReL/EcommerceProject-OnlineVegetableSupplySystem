...
<div class="row">
    <div class= "col-lg-12">
        <ol class="breadcrumb">
            <li class="active">
                <i class="fa fa-dasboard"></i> View Products
            </li>
        <ol>
    </div>
</div>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-hover table-striped">
                        ...
                        ?>
                            <?php 
                            $i=0;
                            $get_product="select * from products where farmer_id='$farm_id'";
                            $run_p=mysqli_query($con,$get_product);
                            while($row=mysqli_fetch_array($run_p)){
                                $pro_id=$row['product_id'];
                                $product_title=$row['product_tltle'];
                            ...
                            <tr>
                                ...
                                <td><img src="product_image/<?php echo $product_img1 ?>" width="50" height="40"></td>
                                <td><?php echo $product_price ?></td>
                                <td><?php echo $product_keyword ?></td>
                                <td><?php echo $date ?></td>
                                
                                <td>
                                    <a href="index.php?delete_p=<?php echo $pro_id ?>">
